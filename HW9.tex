...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    Calculating the MLEs results in $\hat{\alpha} = 4.174581$ and $\hat{\beta} = 1.189099$.
    \item Compute the MLEs for these data using the Log-Normal distribution. \\
    Calculating the MLEs results in $\hat{\mu} = 1.131361$ and $\hat{\sigma} = 0.5333432$.
    ...
    Calculating the likelihood ratio yields the result $2.161318e-07$, which indicates that gamma distribution is a better fit.
    ...
    Calculating the likelihood ratio yields the result $2.37062e+16$, which indicates that weibull distribution is a better fit.
    ...
    Calculating the likelihood ratio yields the result $1.09684e+23$, which indicates that gamma distribution is a better fit.
  \end{enumerate}
